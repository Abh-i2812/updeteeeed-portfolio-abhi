...
export const Component = () => {
  ...
  return (
    <div
      className="kb-viewport flex w-full items-center justify-center overflow-x-hidden bg-[#FAFAFA]"
      style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <div
                className="pointer-events-none absolute inset-0 rounded-[var(--kb-case-radius)] mix-blend-overlay"
                style={{
                  background:
              ...
              <div
                className="pointer-events-none absolute inset-0 rounded-[var(--kb-case-radius)] mix-blend-screen"
                style={{
              ...
              />
              <div
                className="pointer-events-none absolute rounded-tl-[var(--kb-case-radius)] mix-blend-multiply"
                style={{
                  left: 0,
                  top: 0,
                  width: "9%",
              ...
              />
              <div
                className="pointer-events-none absolute rounded-br-[var(--kb-case-radius)] mix-blend-multiply"
                style={{
                  right: 0,
                  bottom: 0,
                  width: "10%",
